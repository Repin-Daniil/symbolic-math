...
std::unique_ptr<Expression> Exponentiation::GetDerivative() {
...
std::optional<std::unique_ptr<Expression>> Exponentiation::Simplify() {
...
std::unique_ptr<Expression> Exponentiation::Clone() {
