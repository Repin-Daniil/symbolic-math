...
Expression& Expression::operator+=(Expression other) {
  ...
  root_ = std::make_unique<Addition>(std::move(root_), std::move(other_ptr));
  Simplify();
...
Expression& Expression::operator/=(Expression other) {
  ...
  root_ = std::make_unique<Division>(std::move(root_), std::move(other_ptr));
  Simplify();
...
Expression& Expression::operator*=(Expression other) {
  ...
  root_ = std::make_unique<Multiplication>(std::move(root_), std::move(other_ptr));
  Simplify();
...
Expression& Expression::operator-=(Expression other) {
  ...
  root_ = std::make_unique<Subtraction>(std::move(root_), std::move(other_ptr));
  Simplify();
...
std::unique_ptr<TreeNode> Expression::GetCopy() const {
  if (!root_) {
    return nullptr;
  }
...
Expression Expression::Substitute(std::unordered_map<Symbol, Expression, SymbolHash> variable_to_value) const {
  ...
  std::unordered_map<Symbol, std::unique_ptr<TreeNode>, SymbolHash> map;
  auto copy = GetCopy();
...
Expression operator-(Expression argument) {
  ...
  std::unique_ptr<TreeNode> new_root = std::make_unique<UnaryMinus>(std::move(root));
...
Expression Log(Expression argument) {
  ...
  std::unique_ptr<TreeNode> new_root = std::make_unique<LogarithmNode>(std::move(root));
...
Expression Sin(Expression argument) {
  ...
  std::unique_ptr<TreeNode> new_root = std::make_unique<SinNode>(std::move(root));
...
Expression Cos(Expression argument) {
  ...
  std::unique_ptr<TreeNode> new_root = std::make_unique<CosNode>(std::move(root));
...
Expression Tan(Expression argument) {
  ...
  std::unique_ptr<TreeNode> new_root = std::make_unique<TangentNode>(std::move(root));
...
Expression Sqrt(Expression argument) {
  ...
  std::unique_ptr<TreeNode> new_root = std::make_unique<SquareRootNode>(std::move(root));
...
Expression Pow(Expression base, Expression power) {
  ...
  std::unique_ptr<TreeNode> new_root = std::make_unique<Exponentiation>(std::move(base_root), std::move(power_root));
  return new_root;
}
