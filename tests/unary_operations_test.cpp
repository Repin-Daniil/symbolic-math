...
TEST_CASE("-5", "UnaryMinus") {
  ...
  CHECK(result->GetInfix() == "-5");
  CHECK(result->GetRPN() == "5 ~");

  CHECK(derivative->GetInfix() == "-0");
...
TEST_CASE("-x", "UnaryMinus") {
  ...
  CHECK(result->GetInfix() == "-x");
  CHECK(result->GetRPN() == "x ~");

  CHECK(derivative->GetInfix() == "-1");
...
TEST_CASE("tan(1)", "Tangent") {
  ...
  CHECK(result->GetInfix() == "tan(1)");
  CHECK(result->GetRPN() == "1 tan");

  CHECK(derivative->GetInfix() == "(0 / (cos(1) ^ 2))");
...
TEST_CASE("tan(x)", "Tangent") {
  ...
  CHECK(result->GetInfix() == "tan(x)");
  CHECK(result->GetRPN() == "x tan");

  CHECK(derivative->GetInfix() == "(1 / (cos(x) ^ 2))");
...
TEST_CASE("tan(x + 25.3)", "Tangent") {
  ...
  CHECK(result->GetInfix() == "tan((x + 25.3))");
  CHECK(result->GetRPN() == "x 25.3 + tan");

  CHECK(derivative->GetInfix() == "((1 + 0) / (cos((x + 25.3)) ^ 2))");
...
TEST_CASE("tan(x) + 12", "Tangent") {
  ...
  CHECK(result->GetInfix() == "(tan(x) + 12)");
  CHECK(result->GetRPN() == "x tan 12 +");

  CHECK(derivative->GetInfix() == "((1 / (cos(x) ^ 2)) + 0)");
...
TEST_CASE("sin(1)", "Sin") {
  ...
  CHECK(result->GetInfix() == "sin(1)");
  CHECK(result->GetRPN() == "1 sin");

  CHECK(derivative->GetInfix() == "(cos(1) * 0)");
...
TEST_CASE("sin(x)", "Sin") {
  ...
  CHECK(result->GetInfix() == "sin(x)");
  CHECK(result->GetRPN() == "x sin");

  CHECK(derivative->GetInfix() == "(cos(x) * 1)");
...
TEST_CASE("sin(x + 25.3)", "Sin") {
  ...
  CHECK(result->GetInfix() == "sin((x + 25.3))");
  CHECK(result->GetRPN() == "x 25.3 + sin");

  CHECK(derivative->GetInfix() == "(cos((x + 25.3)) * (1 + 0))");
...
TEST_CASE("sin(x) + 12", "Sin") {
  ...
  CHECK(result->GetInfix() == "(sin(x) + 12)");
  CHECK(result->GetRPN() == "x sin 12 +");

  CHECK(derivative->GetInfix() == "((cos(x) * 1) + 0)");
...
TEST_CASE("cos(1)", "Cos") {
  ...
  CHECK(result->GetInfix() == "cos(1)");
  CHECK(result->GetRPN() == "1 cos");

  CHECK(derivative->GetInfix() == "-(sin(1) * 0)");
...
TEST_CASE("cos(x)", "Cos") {
  ...
  CHECK(result->GetInfix() == "cos(x)");
  CHECK(result->GetRPN() == "x cos");

  CHECK(derivative->GetInfix() == "-(sin(x) * 1)");
...
TEST_CASE("cos(x + 25.3)", "Cos") {
  ...
  CHECK(result->GetInfix() == "cos((x + 25.3))");
  CHECK(result->GetRPN() == "x 25.3 + cos");

  CHECK(derivative->GetInfix() == "-(sin((x + 25.3)) * (1 + 0))");
...
TEST_CASE("cos(x) + 12", "Cos") {
  ...
  CHECK(result->GetInfix() == "(cos(x) + 12)");
  CHECK(result->GetRPN() == "x cos 12 +");

  CHECK(derivative->GetInfix() == "(-(sin(x) * 1) + 0)");
...
TEST_CASE("ln(x)", "Logarithm") {
  ...
  CHECK(result->GetInfix() == "ln(x)");
  CHECK(result->GetRPN() == "x ln");

  CHECK(derivative->GetInfix() == "(1 / x)");
...
TEST_CASE("ln(x + 25.3)", "Logarithm") {
  ...
  CHECK(result->GetInfix() == "ln((x + 25.3))");
  CHECK(result->GetRPN() == "x 25.3 + ln");

  CHECK(derivative->GetInfix() == "((1 + 0) / (x + 25.3))");
...
TEST_CASE("ln(x) + 12", "Logarithm") {
  ...
  CHECK(result->GetInfix() == "(ln(x) + 12)");
  CHECK(result->GetRPN() == "x ln 12 +");

  CHECK(derivative->GetInfix() == "((1 / x) + 0)");
...
TEST_CASE("sqrt(1)", "SquareRoot") {
  ...
  CHECK(result->GetInfix() == "sqrt(1)");
  CHECK(result->GetRPN() == "1 sqrt");

  CHECK(derivative->GetInfix() == "(0 / (2 * sqrt(1)))");
...
TEST_CASE("sqrt(x)", "SquareRoot") {
  ...
  CHECK(result->GetInfix() == "sqrt(x)");
  CHECK(result->GetRPN() == "x sqrt");

  CHECK(derivative->GetInfix() == "(1 / (2 * sqrt(x)))");
...
TEST_CASE("sqrt(x + 25.3)", "SquareRoot") {
  ...
  CHECK(result->GetInfix() == "sqrt((x + 25.3))");
  CHECK(result->GetRPN() == "x 25.3 + sqrt");

  CHECK(derivative->GetInfix() == "((1 + 0) / (2 * sqrt((x + 25.3))))");
...
TEST_CASE("sqrt(x) + 12", "SquareRoot") {
  ...
  CHECK(result->GetInfix() == "(sqrt(x) + 12)");
  CHECK(result->GetRPN() == "x sqrt 12 +");

  CHECK(derivative->GetInfix() == "((1 / (2 * sqrt(x))) + 0)");
